...
import { drop, move, Mutex, spawn } from "../lib/lib.ts";
...
//     using _guard = lock.acquire(); // THIS NEVER RESOLVES
//     console.log("Handle2 has lock");
//   });
...
//   // 2. Spawn Worker
//   const handle1 = spawn(move(mutex), async (lock) => {
//     const guard = await lock.acquireAsync();
